...
_w['_sydConvTranslation'] = {
  ...
  seeLessGPTs: 'See less Copilot GPTs',
  ...
  configurePanelAffirmationTips: 'By hitting \u0022Publish\u0022, I understand that if I elect to share my Copilot GPT, the name associated with my Microsoft account, and any sensitive or personal data I upload or input to my GPT, may be publicly available or shared with the recipient of my GPT. I also affirm that I have all rights, permissions, and authorizations required to create this GPT and that this GPT, GPT instructions, and any accompanying files comply with the Microsoft Copilot Code of Conduct and Terms and will not infringe or encourage the infringement of any third-party rights (including copyright, trademark, or publicity rights).",',
  ...
  gptCreatorPublishSucceeded: 'Publish Copilot GPT succeeded',
  ...
  pluginPanelFreDismiss: 'Dismiss Plug-in Notifications',
  ...
  pluginSearchBoxPlaceholder: 'Search for chat plugins...',
  activatetoUsePlugins: '激活 {0} 以使用插件',
  threadsToggleExpansion: 'Thread enabled plugin expansion toggle',
  ...
  zeroInputSuggestionFallback5: '匿名使用当日数量限制时需要在右上角自主设置任意Token，并强制清除当前站点全部缓存',
  zeroInputSuggestionFallback6: '创建一个表，帮助我计划接下来两周的就餐',
  zeroInputSuggestionFallback7: '为具有讽刺风格的新社交媒体平台创建一个口号',
  zeroInputSuggestionCategory1: '绘图',
  zeroInputSuggestionCategory2: '比较',
  zeroInputSuggestionCategory3: '体验',
